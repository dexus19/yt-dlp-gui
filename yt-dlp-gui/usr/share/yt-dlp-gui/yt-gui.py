...
class YTDLPDownloader:
    ...
    def _create_widgets(self):
        ...
        ttk.Button(url_frame, text="Paste", command=self._paste_url).pack(side="left", padx=(5, 0))
    ...
    def _build_command(self):
        ...
        if format_choice == "MP3 (audio)":
            ...
            if resolution_choice == "Best":
                ...
                cmd += ["-f", f"bestvideo[height={height}]+bestaudio/best[height={height}]/bestvideo+bestaudio/best", "--merge-output-format", "mp4"]
